...
class RegionSelectionWidget(QWidget):
    ...
    def set_panels_region(self):
        left_panel_region = self.screen_manager.select_regions(
            title="Select left panel",
            multiple=False,
            save_img=False
        )
        right_panel_region = self.screen_manager.select_regions(
            title="Select right panel",
            multiple=False,
            save_img=False
        )
        if left_panel_region and right_panel_region:
            self.panels_region = [left_panel_region, right_panel_region]
